<div class="content-kategori">
    ...
    <div class = "row text-center">
        <div class = "col-4"> 
            <div class="sidenav-kategori-1">
                <a class ="Kategori" href="<?php echo base_url('index.php/CKategori/viewkategoriHome')?>">Kategori</a>
                <?php foreach ($kategori as $ktgr): ?>
                    <div class = "row justify-content-center">
                        <a class = "filter-nama-kategori" href="<?php echo base_url('index.php/CKategori/KategoriNamaHome?filter=').$ktgr->nama?>">  
                ...
                <?php foreach ($makanan as $mkn) : ?>
                    <div class="card ml-3 mb-3 kategori-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?php echo base_url('index.php/login')?>" class="btn btn-primary">Tambahkan ke keranjang</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
